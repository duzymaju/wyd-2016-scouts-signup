 ...
 */
class Version20160725123335 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE pilgrim DROP emergency_info, DROP emergency_phone');
        $this->addSql('ALTER TABLE volunteer DROP emergency_info, DROP emergency_phone');
    }
}
